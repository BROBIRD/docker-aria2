...
C_ARES='https://c-ares.haxx.se/download/c-ares-1.16.0.tar.gz'
OPENSSL='https://www.openssl.org/source/openssl-1.1.1f.tar.gz'
...
ARIA2_SRC() {
    ...
    sed -i 's#"1", 1, 16, #"1", 1, 4096, #g' ./src/OptionHandlerFactory.cc
    sed -i 's#TEXT_MIN_SPLIT_SIZE, "20M", 1_m, 1_g,#TEXT_MIN_SPLIT_SIZE, "20M", 256_k, 1_g,#g' ./src/OptionHandlerFactory.cc
    autoreconf -i
    $ARIA2_VER=master
}
